...
const SHAOLIN_LADDER: GauntletLadderEntry[] = [
  ...
  stage(10, "hard", "第10关·禅武双僧", "mob_monk_14", 1.85, 4, 1.5, { extraEnemyIds: ["mob_monk_15"] }),
  stage(11, "extreme", "第11关·戒律院", "mob_monk_16", 1.95, 4, 1.55, { extraEnemyIds: ["mob_monk_17"], stressCap: 5 }),
  stage(12, "extreme", "第12关·方丈前殿", "mob_monk_18", 2.05, 4, 1.6, { extraEnemyIds: ["mob_monk_19"], stressCap: 5 }),
  stage(13, "extreme", "第13关·罗汉续阵", "mob_monk_07", 2.1, 5, 1.65, { extraEnemyIds: ["mob_monk_08", "mob_monk_09"], stressCap: 5 }),
  stage(14, "extreme", "第14关·护法僧", "mob_monk_10", 2.15, 5, 1.7, { extraEnemyIds: ["mob_monk_11", "mob_monk_12"], stressCap: 5 }),
  stage(15, "extreme", "第15关·期末·方丈座前", "mob_monk_05", 2.35, 5, 1.75, {
    forceGrudge: true,
    stressCap: 6,
    extraEnemyIds: ["mob_monk_06", "mob_monk_07", "mob_monk_08"],
  }),
];
...
const BANDIT_LADDER: GauntletLadderEntry[] = [
  ...
  stage(13, "extreme", "第13关·三匪围殴", "mob_road_11", 2.1, 5, 1.65, { extraEnemyIds: ["mob_road_12", "mob_escortBand_06"], stressCap: 5 }),
  stage(14, "extreme", "第14关·夜劫", "mob_escortBand_07", 2.15, 5, 1.7, { extraEnemyIds: ["mob_escortBand_08", "mob_canal_07"], stressCap: 5 }),
  stage(15, "extreme", "第15关·期末·寨主堂", "mob_escortBand_02", 2.35, 5, 1.75, {
    forceGrudge: true,
    stressCap: 6,
    extraEnemyIds: ["mob_canal_03", "mob_road_05", "mob_road_08"],
  }),
];
...
const COURT_LADDER: GauntletLadderEntry[] = [
  ...
  stage(13, "extreme", "第13关·三卫合围", "mob_court_02", 2.1, 5, 1.65, { extraEnemyIds: ["mob_court_03", "mob_yamenRunner_08"], stressCap: 5 }),
  stage(14, "extreme", "第14关·夺名走卒", "mob_court_04", 2.15, 5, 1.7, { extraEnemyIds: ["mob_court_05", "mob_court_06"], stressCap: 5 }),
  stage(15, "extreme", "第15关·期末·殿前四卫", "mob_court_07", 2.35, 5, 1.75, {
    forceGrudge: true,
    stressCap: 6,
    extraEnemyIds: ["mob_court_08", "mob_court_09", "mob_court_10"],
  }),
];
...
export function isCompanionMilestone(stageCompleted: number): boolean {
  return (COMPANION_MILESTONES as readonly number[]).includes(stageCompleted);
}
