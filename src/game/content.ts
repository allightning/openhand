...
export const CARDS: Record<CardId, CardDef> = {
  ...
  thrust: {
    ...
    cost: 1,
    type: "attack",
    text: "距 2/3/4 伤 3/5/8。贴身可拨杆：低伤并击退 1。",
    flavor: "贴身拨开，远了再戳。",
    damage: 4,
    farBonus: 3,
  },
  ...
  rift: {
    ...
    cost: 1,
    type: "attack",
    text: "打 6，破绽 +1。有印则吃 1 层再 +6 并抽 1。",
    flavor: "缝开了，掌就塞进去。",
    damage: 6,
    expose: 1,
  },
...
export function intentShortName(intent: Intent): string {
  ...
  if (intent.kind === "advance") return "逼近";
  if (intent.kind === "swap") return "换位";
