...
export const LUOYANG_YAMEN_PRISON: MetroScene = {
  ...
  talkers: { m: "luoJailer" },
  portals: { A: { to: "luoyang" as SceneId, at: "GA" } },
  order: [] as SealId[],
...
export const LUOYANG_YANBO_INNER: MetroScene = {
  ...
  npcs: {},
  /** 阿砂仅在内室；鸨母改迎客在外院，此处不重复 */
  talkers: { n: "luoAsha" },
  portals: { A: { to: "luoyang" as SceneId, at: "FA" } },
  order: [] as SealId[],
  gate: "open" as GateKind,
  signs: ["闺房。闲人止步。"],
  items: {} as Record<string, ItemId>,
...
/** 白马寺外院 — 寺僧 / 回主图 */
export const LUOYANG_TEMPLE_OUTER: MetroScene = {
  id: "luoyang_temple_outer" as SceneId,
  chapter: "court" as ChapterId,
  name: "白马寺·外院",
  kicker: "洛阳",
  enter: "古刹钟鸣。石阶苔青。香火自山门起。",
  mood: "方外之地，不涉刀兵。",
  ascii: rows("luoyang_temple_outer", [
    "##############",
    "#l.&......&.l#",
    "#............#",
    "#.g.......g..#",
  ...
  npcs: {},
  talkers: { m: "luoMonk" },
  portals: { A: { to: "luoyang" as SceneId, at: "TB" } },
  order: [] as SealId[],
  gate: "open" as GateKind,
  signs: ["山门。施主请留步。"],
  items: {} as Record<string, ItemId>,
...
export const LUOYANG_SUBSCENES: Record<string, MetroScene> = {
  ...
  luoyang_temple_outer: LUOYANG_TEMPLE_OUTER,
};
