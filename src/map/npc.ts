...
export const LUOYANG_NPCS: LuoNpcFull[] = [
  ...
  build("luoConstable", "young", "m", "yamen", "wrap", "六扇门捕快", null, "sixDoors", [[0, 1], [1, 0]]),
  build("luoConstable2", "mid", "m", "yamen", "blade", "捕快乙", null, "sixDoors", [[1, 0], [-1, 0]]),
  build("luoCaptain", "mid", "m", "martial", "belt", "城防校尉", null, "garrison", [[0, 1], [1, 0]]),
  build("luoGuard", "young", "m", "martial", "wrap", "守备兵", null, "garrison", [[1, 0], [0, 1]]),
  build("luoGuard2", "young", "m", "martial", "base", "守备兵乙", null, "garrison", [[-1, 0], [0, -1]]),
  ...
  build("luoSilk", "mid", "f", "merchant", "shawl", "绸缎庄主", null, "silk", [[0, 1], [1, 0]]),
  build("luoSmith", "mid", "m", "merchant", "wrap", "铁匠", null, "smith", [[0, 1], [-1, 0]]),
  build("luoTemple", "old", "m", "clergy", "staff", "白马寺司", null, "templeOffice", [[0, 1], [1, 0]]),
  build("luoMonk", "mid", "m", "clergy", "staff", "寺僧", null, undefined, [[0, 1], [1, 0]]),
  build("luoPost", "mid", "m", "post", "satchel", "驿邮署吏", null, "post", [[0, 1], [1, 0]]),
  build("messenger", "young", "m", "post", "wrap", "急脚", null, "post", [[0, 1], [1, 0]]),
  // —— 南市 ——
  build("luoAntique", "mid", "f", "merchant", "base", "古董商", "hawker", "shop2", [[0, 1], [1, 0]]),
